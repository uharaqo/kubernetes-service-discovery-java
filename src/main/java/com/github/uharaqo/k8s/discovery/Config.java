...
public final class Config {
  ...
  @Nonnull @Default public final String protocol = "https";

  /** Hostname of the Kubernetes API. Default: "KUBERNETES_SERVICE_HOST" environment variable */
  @Nonnull @Default public final String host = System.getenv("KUBERNETES_SERVICE_HOST");

  /** Port of the Kubernetes API. Default: "KUBERNETES_SERVICE_PORT" environment variable */
  @Nonnull @Default public final String port = System.getenv("KUBERNETES_SERVICE_PORT");

  /** HTTP connect timeout. Default: 5 seconds */
  @Default public final Duration connectTimeout = Duration.ofSeconds(5);

  /** Timeout [seconds] for the GET endpoint API. Default: 5 */
  @Default public final int getTimeoutSec = 3;

  /** Timeout [seconds] for the GET endpoints API with watch query. Default: 60 */
  @Default public final int watchTimeoutSec = 60;
